...
samples, acc_fraction, swap_record, rj_record, ptas, log_likelihood = BayesHopperBurst.run_bhb(N, T_max, n_chain, psrs,
                                                                    max_n_wavelet=5,
                                                                    min_n_wavelet=0,
                                                                    n_wavelet_start=1,
                                                                    RJ_weight=4,
